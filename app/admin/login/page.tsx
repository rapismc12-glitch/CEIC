...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[#070b19] relative overflow-hidden font-sans">
            ...
            <div className="relative z-10 w-full max-w-[460px] px-6 animate-in fade-in zoom-in-95 duration-700 ease-out mx-auto flex flex-col items-center justify-center h-screen">
